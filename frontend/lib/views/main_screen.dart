  ...
  Future<void> _loadState() async {
    ...
    if (mounted) {
      ...
      if (role == 'athlete' && userId != null) {
        ...
        _pollingTimer = Timer.periodic(const Duration(minutes: 5), (_) => _checkRoutineUpdate(userId));
      }
    }
  }
          ...
          if (mounted) {
            ...
            setState(() {
              _notifications.insert(0, NotificationModel(
                ...
                message: message,
                date: DateTime.now(),
                type: isFirstTime ? NotificationType.routineAssigned : NotificationType.routineUpdated,
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: Colors.black.withValues(alpha: 0.08), blurRadius: 25, offset: const Offset(0, 10)),
            ],
          ),
          child: Row(
